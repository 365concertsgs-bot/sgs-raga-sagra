    ...
    return [
      {
        ...
        audioUrl: "",
        placeholder: "Telugu demo video placeholder. The video will be added here later.",
        raga: "Bhairav",
        city: "Delhi",
        country: "India",
      },
    ...
    try {
      ...
      const mapped = eventsData.map((row) => {
        ...
        return {
          ...
          // Placeholder / footnote text (may contain URLs or notes)
          placeholder: getField(row, ["placeholder", "Placeholder", "notes", "Notes", "media_placeholder"]) || null,
          raga: getField(row, [
            "Healing Ragas",
            "Healing_ragas",
            "healing_ragas",
